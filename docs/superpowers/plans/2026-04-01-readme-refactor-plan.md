# README.md Refactor Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers-extended-cc:subagent-driven-development (recommended) or superpowers-extended-cc:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Rewrite README.md as a user-facing quickstart with bird's-eye architecture overview, removing content now in AGENTS.md.

**Architecture:** Single file rewrite. Content is fully specified below — write it exactly.
...
|--------|------|---------------|
| Rewrite | `README.md` | User-facing quickstart + architecture overview |

---

### Task 1: Rewrite README.md

**Goal:** Replace README.md with the new structure: value proposition, usage, architecture overview, slim physics, installation, HPC, development, acknowledgements.

**Files:**
- Rewrite: `README.md`

**Acceptance Criteria:**
- [ ] Title + value proposition with "team of agents" framing
- [ ] Usage examples kept (7 examples + 11-command table with geos:curate-errors)
- [ ] Architecture overview with bird's-eye diagram, compact group table, links to AGENTS.md
- [ ] Slim physics table, no XML example, one-line deferred summary
- [ ] Requirements + installation sections kept
- [ ] HPC section kept
- [ ] Development with updated counts (49 tests, 48 tools, 11 skills)
- [ ] License TBD + acknowledgements kept
- [ ] MCP Tools Reference, Constitutive Assembly Pattern, Knowledge Base sections removed

**Verify:** `wc -l README.md` — expect ~200-250 lines (was 374)

**Steps:**

- [ ] **Step 1: Read existing README.md**

Read `/home/adriano/codes/agents4geosx/README.md` to confirm current content.
...
```bash
git add README.md
git commit -m "docs: refactor README as user-facing quickstart with bird's-eye architecture

- Add agent team framing to title and value proposition
- Move usage examples before installation (show value first)
- Replace full tool inventory with compact group table (details in AGENTS.md)
- Remove constitutive assembly XML example (internal detail)
- Remove knowledge base section (now in AGENTS.md §5)
- Add geos:curate-errors to slash commands table
- Update counts: 48 tools, 49 tests, 11 skills
- Link to AGENTS.md for architecture depth"
```
